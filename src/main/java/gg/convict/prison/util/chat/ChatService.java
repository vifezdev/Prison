...
import gg.convict.prison.util.chat.impl.PublicChat;
...
public class ChatService {
    ...
    public static void loadChatChannel(UUID uuid) {
        playerChatChannels.put(uuid,
            ...
            if (redis.hexists("ChatChannel:" + PrisonPlugin.getServerNameGetter().apply(null),
                    uuid.toString()))
                localChannel = fromName(redis.hget("ChatChannel:" + PrisonPlugin.getServerNameGetter().apply(null),
                        uuid.toString()));
